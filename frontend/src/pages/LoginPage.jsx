            ...
            <div className="mt-4 pt-3 border-t border-border space-y-2">
              ...
              {portalMode === 'student' ? (
                ...
                <div className="grid grid-cols-2 gap-2">
                  <button
                    type="button"
                    onClick={() => handleQuickLogin('director@demo.edu', 'Demo1234!', 'faculty')}
                    disabled={loading}
                    className="rounded-md border border-border bg-secondary/50 p-2 text-xs text-left hover:border-primary/40 hover:bg-secondary transition-all cursor-pointer"
                  >
                    <div className="font-semibold text-foreground text-[11px]">Director</div>
                    <div className="text-[10px] text-muted-foreground truncate">director@demo.edu</div>
                  </button>

                  <button
                    type="button"
                    onClick={() => handleQuickLogin('principal@demo.edu', 'Demo1234!', 'faculty')}
                    disabled={loading}
                    className="rounded-md border border-border bg-secondary/50 p-2 text-xs text-left hover:border-primary/40 hover:bg-secondary transition-all cursor-pointer"
                  >
